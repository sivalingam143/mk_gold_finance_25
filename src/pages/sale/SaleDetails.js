...
const SaleDetails = () => {
  ...
  const handleUpdateSubmit = async () => {
    ...
    try {
      const response = await fetch(`${API_DOMAIN}/sale.php`, {
        ...
        body: JSON.stringify({
          edit_sale_id: rowData.sale_id, // Include the company ID in the request
      ...
      console.log(
        JSON.stringify({
          edit_sale_id: rowData.Group_id, // Include the company ID in the request
          sale_no: formData.sale_no,
          sale_name: formData.saleName,
          gurdian_name: formData.name_of_guardians,
          address: formData.Address,
  ...
  useEffect(() => {
    if (rowData) {
      setFormData({
        saleName: rowData.sale_name || "",
        Address: rowData.address || "",
        Place: "",
        MobileNo: rowData.mobile_number || "",
        sale_no: rowData.sale_no || "",
          ...
          <Container>
            <Row className="regular">
              <Col lg="12" md="12" xs="12" className="py-3">
                <PageNav pagetitle={"sale Details"}></PageNav>
              </Col>
              ...
              <Col lg="3" md="4" xs="12" className="py-3">
                <TextInputForm
                  ...
                  onChange={(e) => handleChange(e, "sale_no")}
                ></TextInputForm>
              </Col>
              <Col lg="3" md="4" xs="12" className="py-3">
                <TextInputForm
                  ...
                  onChange={(e) => handleChange(e, "saleName")}
                ></TextInputForm>
              </Col>
              <Col lg="3" md="4" xs="12" className="py-3">
                <TextInputForm
