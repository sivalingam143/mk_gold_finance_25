...
const LoanReceiptPDF = ({ data }) => {
  ...
  const customerImage =
    data.proof && data.proof.length > 0 ? data.proof[0].data : null;
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ lineHeight: 1.8 }}>
          <Text style={styles.loan1Paragraph}>
            ...
            முத்துராஜ், {data.customer_details}, {data.place} என்ற முகவரியில்
          ...
          <Text style={[styles.loan1Paragraph, { marginTop: 8 }]}>
            ...
            இதற்கு முழு மனதுடன் சம்மதிக்கிறேன் என்பதை {""} இதன் மூலம்
