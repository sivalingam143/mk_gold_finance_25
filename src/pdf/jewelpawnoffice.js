...
const styles = StyleSheet.create({
  ...
  infoItem: {
    width: "45%",
    flexDirection: "row",
    alignItems: "flex-start", // aligns text nicely at the top
    marginBottom: 9,
  },
...
const OfficeCopyDocument = ({ data }) => {
  ...
  const totalCount = data.jewel_product.reduce(
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.subText]}>Licence No: TN-2020250508106</Text>
          <Text style={styles.subText}>
            {" "}
            No.12-E, P.S.R. Road, Sivakasi - 626123, Phone No : 04562-221465,
            8489020465,8667059782{" "}
          </Text>
        </View>
            ...
            <View style={[styles.column, { flex: 1, alignItems: "center" }]}>
              <View style={styles.infoItem}>
                {data.proof?.[0] ? (
                  ...
                  <Text style={styles.value}>படம் இல்லை</Text>
                )}
              </View>
            </View>
          </View>
        ...
        <View>
          ...
          >
            ...
            <View
              style={[
                { flex: 6, marginRight: 10, fontFamily: "NotoTamil-Bold" },
              ]}
            >
              <Text>
                பெயர் : {data.name ?? "N/A"}
        ...
        <Text style={{ fontFamily: "NotoTamil-Bold", marginBottom: 1 }}>
          நகை பற்றிய விபரம் :
        </Text>
        <View
          style={{
    ...
    <Text style={{ fontSize: 8, fontFamily: 'NotoTamil' }}>கையொப்பம்</Text>
        ...
        <Text style={{ marginTop: 3 }}>
          ...
          பெற்றுக்கொண்டு கீழ்க்கண்ட நபரிடம் ஒப்படைக்க வேண்டுகிறேன். வாரிசுதாரர்
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View>
          <Text style={styles.item}>
            1. கடன் 30 நாட்களுக்குள் முன்பு மூடப்பட்டது என்றால்; குறைந்தபட்ச
            காலம் 15 நாட்களுக்கான வட்டி வசூலிக்கப்படும்.{" "}
          </Text>
          <Text style={styles.item}>
            2. பிராமிசரி நோட்டில் குறிக்கப்பட்ட வட்டி விகிதத்தையும் அவ்வப்போது
            நிர்வாகம் நிர்ணயிக்கின்ற மற்ற கட்டணத்தையும் கடன்தாரர்
            செலுத்தவேண்டும்.{" "}
          </Text>
          <Text style={styles.item}>
            3. தவறும் பட்சத்தில் கடனுக்கு அடமானமாக கொடுத்த பொருளை இந்த கடனுக்கோ
            அல்லது கடன்தாரரிடமிருந்து நிர்வாகத்திற்கு சேரவேண்டிய மற்ற
            தொகைக்காகவோ தக்கவைத்துக்கொள்ள நிர்வாகத்திற்கு உரிமையுண்டு.{" "}
          </Text>
          <Text style={styles.item}>
            4. நிர்வாகத்திற்கு சாதகமாக கடன் பெறுபவர் எழுதிக்கொடுத்த ஒப்பந்தம்
            மற்றும் பிற ஆவணங்களையும் எப்போது வேண்டுமானாலும், ஏனைய வங்கி மற்றும்
            நிதி நிறுவனங்களுக்கு மாற்றம் செய்து பணம் பெற்றுக்கொள்ள
            நிர்வாகத்திற்கு உரிமையுண்டு.{" "}
          </Text>
          <Text style={styles.item}>
            5. அடமானம் பெற்ற நகைகளை நிர்வாக அலுவலர்களோ தணிக்கை அதிகாரிகளோ தரத்தை
            சோதித்து பார்ப்பதற்கு முழு அதிகாரம் உண்டு.{" "}
          </Text>
          <Text style={styles.item}>
            6. நகைக்கடன் பெறுவது, வட்டி செலுத்துவது, திருப்புவது ஆகிய காரியங்களை
            அலுவலக வேலை நேரத்தில் மாத்திரமே செய்து கொள்ள முடியும். எந்தவொரு தவணை
            தேதியும் விடுமுறை நாளன்று வருமானால் விடுமுறைக்கு முந்திய வேலை நாள்
            தவணை தேதியாக எடுத்துக் கொள்ளப்படும்.{" "}
          </Text>
          <Text style={styles.item}>
            7. கடன் மற்றும் வட்டியை கடன்தாரரோ அல்லது அவரால் அதிகாரம் பெற்றவர்களோ
            திருப்பி செலுத்த முடியும். கடன்தாரரோ அல்லது அவரால் எழுத்துமூலம்
            அதிகாரம் பெற்றவரோ அசல் மற்றும் வட்டியை திருப்பி செலுத்தி அடகு
            சீட்டையும் கொடுக்கும் பட்சத்தில் நகையினை திருப்பிக்கொள்ளலாம்.
            கடன்தாரர் வாரிசுதாரர்களை நியமிக்காதபடி இருந்தால் மேற்படி நகைகளை
            சட்டப்படியான உரிய தொகையை பெற்றபிற்பாடு ஒப்படைக்கப்படும்.{" "}
          </Text>
          <Text style={styles.item}>
            8. சட்ட விரோத காரியங்களுக்கு இந்த கடன் உபயோகப்படுத்தப்படமாட்டது
            என்பதை கடன்தாரர் உறுதி செய்கிறார்.{" "}
          </Text>
          <Text style={styles.item}>
            9. கடனில் பகுதி தொகை மட்டும் செலுத்தும்பட்சத்தில் முதலாவது வட்டி
            கழிக்கப்பட்டு எஞ்சிய தொகை மாத்திரமே அசலில் வரவு வைக்கப்படும்.{" "}
          </Text>
          <Text style={styles.item}>
            10. முகவரி மாற்றத்தை நிர்வாகத்திற்கு எழுத்து மூலம் கொடுத்து ஒப்புதல்{" "}
            பெற்றுக்கொள்ள வேண்டும். அல்லாத பட்சத்தில் வாடிக்கையாளர்கள்
            விண்ணப்படிவத்தில் தெரிவித்துள்ள முகவரி மாத்திரமே அனைத்து விதமான
            காரியங்களுக்கும் பயன்படுத்திகொள்ளப்படும். தவறும் பட்சத்தில்
            நிர்வாகம் பொறுப்பேற்காது.{" "}
          </Text>
          <Text style={styles.item}>
            11. அடமானம் வைக்கப்பட்ட நகை, கடன்தாரர்க்கு சொந்தமானதாகும்.
            மற்றவர்கள் யாரும் அதன்மீது உரிமை கொண்டாட இயலாது. இதை அடமானம் செலவு
            மற்றும் பின்விளைவுகளிலிருந்து பாதுகாக்க வேண்டும்.{" "}
          </Text>
          <Text style={styles.item}>
            12. பிராமிசரி நோட்டீஸ் குறிக்கப்பட்ட கடன் காலம் காலாவதியாவதற்குள்
            அல்லது நிர்வாக சொன்ன தேதியிலோ கடன் பெற்றவர் முழுத்தொகையும் செலுத்த
            தவறினால் அடமானம் வைக்கப்பட்ட நகைகளை நிர்வாகம், 2 வாரகால நோட்டீஸ்
            கொடுத்த பிறகு நிர்வாகம் விற்கும். நகை விற்றப்பின் பற்றாக்குறையாய்
            இருக்குமாயின் கடன்தாரரிடமிருந்து வசூலிக்கப்படும். உபரியாக இருக்கும்{" "}
            பட்சத்தில் நிர்வாகத்திற்கு சேரவேண்டிய நகைக்கடன் தொகைகளை நிர்வாகம்
            எடுத்துக்கொள்ளும். ஏதேணும் உபரிதொகை இருப்பின் 30 நாட்களுக்குள்{" "}
            வழங்கப்படும்.{" "}
          </Text>
          <Text style={styles.item}>
            13. தங்க நகைகள் கொடுப்பது, வட்டியுடன் வசூல்செய்வது, பிணையமாக
            வைக்கப்பட்டுள்ளவைகளை, விற்று பணமாக்குவது, இவற்றுக்கான செலவுகள்,
            அரசாங்கத்திற்கு செலுத்த வேண்டிய வரி மற்றும் இதர செலவீனங்கள்,
            நிர்வாகம் செலவு, வட்டி வரி, சேவை வரி, பத்திர செலவு, விற்பனை வரி,
            மதிப்புக்கூட்டும் வரி முதியவற்றை கடன்தாரர் ஏற்றுக்கொள்ள வேண்டும்.
            அல்லது அவற்றை நிர்வாகத்திற்கு செலுத்த வேண்டும்.{" "}
          </Text>
          <Text style={styles.item}>
            14. எதிர்பாராத சூழ்நிலை காரணமாக அடமானம் வைக்கப்பட்ட நகைகளுக்கு
            சேதாரம் ஏற்பட்டால் அடமான ரசீதில் குறிப்பிடப்பட்ட எடைக்கு சமமான நகையை
            நிர்வாகம் கொடுக்கும் அல்லது அந்த எடைக்கு சமமான மார்க்கெட் நிலவர
            மதிப்பின் படி தொகையை கொடுக்கும். இப்படி இழப்பீட்டுத் தொகைபெறும்முன்
            நிர்வாகத்திற்கு சேரவேண்டிய அசல், வட்டி மற்றும் இதர செலவுகளை
            நேர்செய்ய வேண்டியது கட்டாயமாகும்.{" "}
          </Text>
          <Text style={styles.item}>
            15. கடன்தாரர் தெரிவிக்கும் தங்கத்தின் தரத்திணை அப்படியே
            ஏற்றுக்கொண்டு கடன் வழங்கப்படுகின்றது. பின்நாளில் மேற்படி நகை தரம்
            குறைந்தது அல்லது போலியானது என்று கண்டுபிடிக்கப்பட்டால் கடன்தாரர்
            மீது கிரிமினல் வழக்கு தொடரப்படும் கடன் வசூலிக்கப்படும். இதற்காகும்
            செலவுகளுக்கெல்லாம் கடன்தாரே பொறுப்பாவார்.{" "}
          </Text>
          <Text style={styles.item}>
            16. நிர்வாகம் கொடுத்த அடமான இரசீது தொலைந்துவிட்டாலோ அல்லது காணாமல்
            போனாலோ நகையை அடமானம் வைத்தவர் உரிய மதிப்பிற்குரிய பத்திரத் தாளில்
            ஒப்பந்தம் எழுதிக்கொடுத்து நகையை மீட்டுக்கொள்ளலாம்.{" "}
          </Text>
          <Text style={styles.item}>
            17. நான் அடமானமாக வைக்க தங்கள் நிறுவனத்திற்கு கொண்டு வந்து இருக்கும்
            நகைகள் அனைத்தும் என்னுடைய சொந்த நகைகள் தான் என்பதை உறுதியுடன்
            தெரிவித்துக் கொள்கிறேன்.{" "}
          </Text>
          <Text style={styles.item}>
            18. வாடிக்கையாளர்கள் தாங்கள் அடகு வைக்கும் நகைகளை வங்கி வேலை
            நாட்களில் மீட்டுக் கொள்ள வேண்டும். காலை 10:30 மணி முதல் மாலை 02.30
            மணிக்குள் நகைகள் திருப்பிக் கொள்ளலாம்.{" "}
          </Text>
          <Text style={styles.item}>
            19. நகைக்கடன் சம்பந்தமாக அதன் விதிமுறைகளைக் கூட்டவோ, மாற்றவோ,
            நீக்கவோ நிறுவனத்திற்கு முழு உரிமையுண்டு.{" "}
          </Text>
          <Text style={styles.item}>
            20. பிரதி வாரம் (2) இரண்டாவது மற்றும் (4)நான்காவது சனிக்கிழமைகளில்
            பொருள் திருப்ப இயலாது.{" "}
          </Text>
        </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          />
          <Text style={[styles.centerText, { textDecoration: "underline" }]}>
            உறுதிமொழி படிவ{""}ம்
          </Text>
        </View>
        ...
        >
          ...
          <View style={{ width: "70%" }}>
            ...
            <View style={{ marginLeft: 10 }}>
              ...
              <Text style={styles.item}>
                அடகு தேதி - {formatDate(data.pawnjewelry_date)}
              </Text>
              <Text style={styles.item}>
                கடன் தொகை -{" "}
                {Number(data.original_amount).toLocaleString("en-IN")}/-
        ...
        <View style={{ lineHeight: 2.5 }}>
          <Text style={styles.loan1Paragraph}>
            நான் <Text style={styles.sectionTitle}>{data.name}</Text> s/o
            ..........., {data.customer_details}, {data.place} என்ற முகவரியில்
            வசித்து வருகிறேன். மேலும் என்னுடைய சொந்த தேவைக்காக இன்று{" "}
            {formatDate(data.pawnjewelry_date)} தங்களது பைனான்ஸ்-ல் என்னுடைய
            சொந்த நகையை மட்டுமே அடமானம் வைக்கின்றேன் என்பதை தெரிவித்து {""}
            கொள்கிறேன்.
          </Text>
          ...
          <Text style={[styles.loan1Paragraph, { marginTop: 8 }]}>
            நான் திருப்பும் தேதி 16-01-2026 வரும் வரை நகையினை திரும்ப பெற இயலாது
            என்பதை நான் அறிந்து அதற்கு முழு மனதுடன் சம்மதித்து அடகு வைக்கிறேன்.
            நகை திருப்பும் தவணை தேதி முடிந்த பிறகும் வட்டி செலுத்தவில்லை என்றால்
            1 மாதத்திற்கு ஒருமுறை 1% வட்டி விகிதம் மாறுபடும் என்பதையும் மற்றும்
            நகையை திருப்புவதாக இருந்தால் இரண்டு நாட்களுக்கு முன்னர் நகையின்
            வட்டியை செலுத்திவிட்டு பின்னர் நகையின் அசலை செலுத்தி திருப்ப இயலும்
            என்பதையும் நான் அறிவேன்.
          </Text>

          <Text style={[styles.loan1Paragraph, { marginTop: 8 }]}>
            இதில் கண்ட அனைத்தையும் நான் தெரிந்து கொண்டும் புரிந்து கொண்டும்
            இதற்கு முழு மனதுடன் சம்மதிக்கிறேன் என்பதை இத{""}ன் {""}மூலம்
        ...
        >
          <View>
            <Text style={styles.value}>
              நாள் : {formatDate(data.pawnjewelry_date)}
            </Text>
